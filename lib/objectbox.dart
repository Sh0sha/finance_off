...
import 'package:financeOFF/data/setup/default_acc.dart';
import 'package:financeOFF/data/setup/default_category.dart';
...
class ObjectBox {
  ...
  Future<void> createAndPutDebugData() async {
    ...
    final services = categories.firstWhere((element) =>
        element.iconCode ==
        const IconFinIcon(Symbols.cloud_circle_rounded).toString());
    final coffee = categories.firstWhere((element) =>
        element.iconCode ==
        const IconFinIcon(Symbols.local_cafe_rounded).toString());
    final gift = categories.firstWhere((element) =>
        element.iconCode ==
        const IconFinIcon(Symbols.featured_seasonal_and_gifts_rounded)
            .toString());
    final paycheck = categories.firstWhere((element) =>
        element.iconCode ==
        const IconFinIcon(Symbols.wallet_rounded).toString());
    final rent = categories.firstWhere((element) =>
        element.iconCode ==
        const IconFinIcon(Symbols.request_quote_rounded).toString());
