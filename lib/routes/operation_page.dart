...
import 'package:financeOFF/routes/new_transaction/list_select_acc.dart';
import 'package:financeOFF/routes/new_transaction/list_select_category.dart';
...
import 'package:financeOFF/widgets/transaction/type_selector.dart';
...
class TransactionPage extends StatefulWidget {
  ...
  const TransactionPage.create({
    super.key,
    this.initialTransactionType = TransactionType.rashod,
  }) : transactionId = 0;
...
class _TransactionPageState extends State<TransactionPage> {
  ...
  void initState() {
    ...
    categories = ObjectBox().getCategory();
    ...
    if (!widget.isNewTransaction && _currentlyEditing == null) {
      ...
      _amount = _currentlyEditing?.isTransfer == true
          ...
          : _currentlyEditing?.amount ??
              (_transactionType == TransactionType.rashod ? -0 : 0);
      ...
      child: Focus(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            leadingWidth: 40.0,
            title: TypeSelector(  /// Выбор типа транзакции
                ...
                child: Column(
                  children: [
                    ...
                    if (_currentlyEditing != null) ...[
                      const SizedBox(height: 24.0),
                      Text(
                        "${"transaction.createdDate".t(context)} ${_currentlyEditing.createdDate.format(payload: "LL H:m", forceLocal: true)}",
  ...
  void inputAmount() async {
    ...
    final double? resultAmount = result == null
        ...
        : switch (_transactionType) {
            TransactionType.rashod => -result.abs(),
            TransactionType.dohod => result.abs(),
